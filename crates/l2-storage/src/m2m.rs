...
impl M2mStorage {
    ...
    #[cfg_attr(feature = "profiling", tracing::instrument(skip(self, breakdown), level = "debug", name = "m2m_reserve_fee"))]
    ...
    #[cfg_attr(feature = "profiling", tracing::instrument(skip(self), level = "debug", name = "m2m_finalise_fee"))]
